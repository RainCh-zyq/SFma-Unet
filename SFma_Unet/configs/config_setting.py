...
class setting_config:
    ...
    if datasets == 'ISIC2017':
        data_path = '/home/dell/User_student/Zyq/SFma-Unet/dataprepare/ISIC2017-1/'
    elif datasets == 'ISIC2018':
        data_path = '/home/dell/User_student/Zyq/SFma-Unet/dataprepare/ISIC2018-1/'
    else:
    ...
    work_dir = 'result/' + network + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
